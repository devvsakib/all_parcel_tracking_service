...
const RedX = () => {
    ...
    return (
        <div>
            ...
            <div>
            <div class="ant-row">
    <div class="ant-col ant-col-md-16 ant-col-xl-16">
        <div class="left-side">
            <div class="header">
                <div class="caption">
                    <p class="title css-1y8lftn">ট্র্যাক পার্সেল</p>
                    <button type="button" class="ant-btn ant-btn-link issue"><span role="img" aria-label="flag" class="anticon anticon-flag">svg</span><span> Raise an Issue</span></button>
                </div>
            ...
            <div class="body">
                <div class="header">
                    ...
                    <div class="subtitle-wrapper">
                        <p class="subtitle css-8fv8tv">20A719SU147NN</p>
                    </div>
                </div>
                <div class="tracking-wrapper">
                    <div class="vertical-timeline vertical-timeline--one-column">
                        <div id="" class="vertical-timeline-element--work vertical-timeline-element">
                            <span style="background: rgb(19, 160, 84); color: rgb(255, 255, 255);" class="vertical-timeline-element-icon bounce-in"><span role="img" aria-label="check" class="anticon anticon-check">svg</span></span>
                        ...
                        <div id="" class="vertical-timeline-element--work vertical-timeline-element">
                            <span style="background: rgb(255, 255, 255); color: rgb(19, 160, 84);" class="vertical-timeline-element-icon bounce-in"><span role="img" aria-label="check" class="anticon anticon-check">svg</span></span>
                            <div class="vertical-timeline-element-content bounce-in">
                                <div class="vertical-timeline-element-content-arrow"></div>
    ...
    <div class="ant-col ant-col-md-8 ant-col-xl-8">
